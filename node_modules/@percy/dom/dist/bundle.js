(function() {
  (function (exports) {
    ...
    function handleErrors(error, prefixMessage, element = null, additionalData = {}) {
      let elementData = {};
      if (element) {
        elementData = {
    ...
    function setBaseURI(dom, warnings) {
      var _parsedURL, _dom$querySelector;
      let parsedURL;
      try {
        parsedURL = new URL(dom.baseURI);
      } catch (e) {
        warnings === null || warnings === void 0 || warnings.add(`Could not parse baseURI for iframe: ${dom.baseURI}`);
        return;
      }
      if (!((_parsedURL = parsedURL) !== null && _parsedURL !== void 0 && _parsedURL.hostname)) return;
